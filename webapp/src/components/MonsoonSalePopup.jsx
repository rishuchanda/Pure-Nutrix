          ...
          >
            ...
            <div className="sale-popup-content">
              <div className="sale-popup-icon">
                <CloudRain size={44} color="var(--color-accent-emerald)" />
              </div>
              <h2 className="sale-popup-title text-gradient">Monsoon Mega Sale</h2>
              <h3 className="sale-popup-subtitle text-gold">Buy 1 Get 1 FREE</h3>
              <p className="sale-popup-desc">
                Refresh your radiance this monsoon season. Buy any Pure Nutrix product and get another one absolutely free. Offer applies automatically at checkout!
              </p>
